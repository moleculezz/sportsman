...
<form action="" method="post" class="-koowa-form">
        ...
        <div class="panel">
            ...
            <table class="admintable">
                ...
                <tr>
                    ...
                    <td>
                        <input class="required validate-email" type="text" name="email" value="<?= $member->email ?>"
                               size="40"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input class="required maxLength:1" type="text" name="gender" value="<?= $member->gender ?>"
                               maxlength="1" size="2"/>
                    </td>
                </tr>
                <tr>
        ...
        <div class="panel">
            ...
            <table class="admintable">
                <tr>
                    ...
                    <td>
                        <input class="required minLength:2" type="text" name="username" value="<?= $member->username ?>"
                ...
                <tr>
                    ...
                    <td>
                        <input class="validate-match matchInput:'password' matchName:'password'" type="password"
                               name="password_verify" maxlength="100" size="40"/>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="grid_4">
        <div class="panel">
            ...
            <table class="admintable">
                <tr>
                    ...
                    <td>
                        <?= @helper('select.booleanlist', array('name'     => 'enabled',
                ...
                <tr>
                    ...
                    <td>
                        <?= @helper('select.booleanlist', array('name'     => 'send_email',
                                                                'selected' => $member->send_email)) ?>
                    </td>
                </tr>
                <? if (!$member->isNew()): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?= @text('Never') ?>
                        <? else : ?>
                        <?= @helper('date.format', array('date'   => $member->registered_on,
                                                         'format' => '%Y-%m-%d %H:%M:%S')) ?>
                        <? endif ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <?= @text('Never') ?>
                        <? else : ?>
                        <?= @helper('date.format', array('date'   => $member->last_visited_on,
                                                         'format' => '%Y-%m-%d %H:%M:%S')) ?>
                        <? endif ?>
                    </td>
                </tr>
        ...
        <div class="panel groups">
            <h3><?= @text('Group') ?></h3>
            <?= @helper('com://admin/groups.template.helper.select.groups', array('selected' => $member->id ? $member->users_group_id : 18,
                                                                                  'name'     => 'users_group_id',
