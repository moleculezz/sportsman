    ...
    <div class="grid_8">
        <div class="panel title group">
            <input class="inputbox required" type="text" name="title" id="title" size="40" maxlength="255"
                   value="<?= @escape($tournament->title) ?>" placeholder="<?= @text('Name') ?>"/>
        </div>
    </div>
    <div class="grid_4">
        <div class="panel">
            ...
            <table class="admintable">
                ...
                <tr>
                    ...
                    <td>
                        <?= @helper('behavior.calendar', array('date' => $tournament->created_on,
                                                               'name' => 'created_on')); ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <?= @helper('behavior.calendar', array('date' => $tournament->ended_on,
                                                               'name' => 'ended_on')); ?>
                    </td>
                </tr>
            </table>
