...
<form action="<?= @route('id=' . $game->id) ?>" method="post" id="game-form" class="-koowa-form">
    <div class="grid_8" id="game-container">
        <div class="grid_12 panel title group tournament">
            ...
            <?=@helper('listbox.tournaments', array('name'     => 'sportsman_tournament_id',
                                                    'selected' => $game->sportsman_tournament_id)); ?>
        </div>
        ...
        <div class="grid_5">
            <div class="grid_12 panel title group droppable game" id="home-team">
                ...
                <input class="team_id validate-team" type="hidden" name="home_team_id" id="home_team_id"
                       value="<?= $game->home_team_id ?>"/>
                <!-- <label for="home_team_score"><?php //@text('Score') ?></label> -->
                <input class="inputbox required validate-integer" type="text" name="home_team_score"
                       id="home_team_score" size="5" maxlength="3" value="<?= @escape($game->home_team_score) ?>"
                       placeholder="Score"/>
            </div>
        </div>
        <div class="grid_2">
        ...
        <div class="grid_5">
            <div class="grid_12 panel title group droppable game" id="away-team">
                ...
                <input class="team_id validate-team" type="hidden" name="away_team_id" id="away_team_id"
                       value="<?= $game->away_team_id ?>"/>
                <!-- <label for="away_team_score"><?php //@text('Score') ?></label> -->
                <input class="inputbox required validate-integer" type="text" name="away_team_score"
                       id="away_team_score" size="5" maxlength="3" value="<?= @escape($game->away_team_score) ?>"
                       placeholder="Score"/>
            </div>
        </div>
    </div>
        ...
        <div class="panel">
            ...
            <table class="admintable">
                <tr>
                    ...
                    <td>
                        <?= @helper('behavior.calendar', array('date' => $game->game_time,
                                                               'name' => 'game_time')); ?>
                    </td>
                </tr>
                <tr>
