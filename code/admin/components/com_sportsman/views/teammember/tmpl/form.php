        ...
        <div class="panel">
            ...
            <table class="admintable">
                <tr>
                    ...
                    <td>
                        <?=@helper('listbox.members_type', array('name' => 'type', 'selected' => $teammember->type)); ?>
                    </td>
                </tr>
                <tr>
                    <td class="key">
                    ...
                    <td>
                        <input class="validate-integer maxLength:2" type="text" name="jersey_number" value="<?= $teammember->jersey_number ?>" size="3" />
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="panel">
            ...
            <table class="admintable">
                <tr>
                    ...
                    <td>
                        <?= @helper('behavior.calendar', array('date' => $teammember->created_on, 'name' => 'created_on')); ?>
                    </td>
                </tr>
                <tr>
                    <td class="key">
                    ...
                    <td>
                        <?= @helper('behavior.calendar', array('date' => $teammember->ended_on, 'name' => 'ended_on')); ?>
                    </td>
                </tr>
            </table>
        </div>
